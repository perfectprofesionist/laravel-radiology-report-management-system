                        ...
                        <div class="patient-information-inn patient-wrap">
                            <div class="form-field-row full-row">
                                <div class="form-field">
                                    ...
                                    <input type="file" class="form-control @error('avatar') is-invalid @enderror d-none" id="avatar" name="avatar" disabled accept="image/*">
                                    @error('avatar')
                            ...
                            <div class="form-field-row full-row adminCSTMoption">
                                <div class="form-field">
                                    ...
                                    <input type="text" name="first_name" placeholder="Enter first name" value="{{ old('first_name', $user->first_name) }}" readonly />
                                    @error('first_name')
                                        <small class="text-danger d-block mt-1 server_error">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="form-field">
                                    ...
                                    <input type="text" name="last_name" placeholder="Enter last name" value="{{ old('last_name', $user->last_name) }}" readonly />
                                    @error('last_name')
                                        <small class="text-danger d-block mt-1 server_error">{{ $message }}</small>
                                    @enderror
                                </div>
...
function toggleUserOptions(role) {
    ...
    const currentUserRole = @json($user->getRoleNames()->first());
    $(document).ready(function () {
        toggleUserOptions(currentUserRole);
    });
