...
{{-- Main examination list interface for viewing and managing radiology requests --}}
<div class="right-body-con">
    <div class="right-body-con-inn">
        <div class="deshboard-table">
            {{-- Header controls section with status filter and search --}}
            ...
            {{-- DataTable container for displaying examination requests --}}
            <div class="des-table">
